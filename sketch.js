...
function preload(){
 ...
 player_down = loadImage("img3.png")
 player_left = loadImage("img302.png")
 player_right = loadImage("img303.png")
 reset = loadImage("reset_img.png")
}
...
function setup() {
  ...
  reset_button = createSprite(1800,100,50,50)
  ...
  finishLine1 = createSprite(890,90,150,100)
  //bus1.visible = false
...
function draw() {
 ...
 if(keyDown("S")||keyDown("DOWN_ARROW")){
  player1.y = player1.y+10
  player1.addImage(player_down)
 }
 if(keyDown("A")||keyDown("LEFT_ARROW")){
  player1.x = player1.x-10
  player1.addImage(player_left)
 }
 if(keyDown("D")||keyDown("RIGHT_ARROW")){
  player1.x = player1.x+10
  player1.addImage(player_right)
 }
...
text("Complete Game before the time is 2000",110, 60)
textSize(40)
fill("white")
text("FINISH",825,120)
if(player1.isTouching(finishLine1)){
 textSize(128)
 fill("black")
...
textSize(64)
  fill("black")
  text("Click Reset to start over",110,180)
}
